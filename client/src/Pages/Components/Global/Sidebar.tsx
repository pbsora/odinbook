...
const Sidebar = ({ open, setOpen }: Props) => {
  return (
    <aside
      ...
      }  w-screen py-24 -none px-8 h-screen bg-white gap-8 border-t filter flex flex-col items-center lg:items-baseline z-40 lg:h-[55vh] lg:sticky lg:top-28 lg:blur-none shadow-xl lg:w-[30vw] xl:w-[20vw] lg:border border-zinc-400 lg:rounded-xl transition-all duration-500 ease-in-out`}
    >
      <Link
        to={"/"}
